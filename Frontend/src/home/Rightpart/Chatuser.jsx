...
function Chatuser() {
  ...
  return (
    ...
    <div className="relative flex items-center h-[8%] justify-center gap-4 bg-slate-800 hover:bg-slate-700 duration-300 rounded-md">
      ...
      <div className="flex space-x-3 items-center justify-center bg-gray-800 h-[8vh] hover:bg-gray-700 duration-300 ">
        ...
        <div>
          <h1 className="text-md">{selectedConversation.fullname}</h1>
